...
export async function POST(req: Request) {
  try {
    ...
    // We generate a base image that the frontend will animate with Ken Burns effects
    const baseImageUrl = `https://image.pollinations.ai/prompt/${encodeURIComponent(enhancedPrompt)}?seed=${seed}&width=${width}&height=${height}&nologo=true&model=flux&enhance=false`;
    ...
    // Return the image URL marked as motion graphics
